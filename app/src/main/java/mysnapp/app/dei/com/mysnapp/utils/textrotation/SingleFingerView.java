...
public class SingleFingerView extends LinearLayout {
    ...
    public SingleFingerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        vto.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                mView.setOnTouchListener(new ViewOnTouchListener(mPushView, mEditbtn, width, height, false));
    ...
    public void showBackground() {
        mView.setBackgroundResource(R.drawable.roundednew);
    ...
    public EditText getTextView() {
        return (EditText) mView.findViewWithTag("213");
    }
